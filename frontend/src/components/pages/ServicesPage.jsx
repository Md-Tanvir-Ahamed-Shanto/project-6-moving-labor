  ...
  return (
    <div className="w-full py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center text-[#0A4B8F] mb-4">Our Services</h1>
        <p className="text-gray-600 text-center max-w-3xl mx-auto mb-12">
          UK Movers Are A Specialist Moving Company That Deal With All UK & European
          Moves, Packing & Unpacking, Cleaning And Furniture Dismantling & Reassembling
          Services.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <div 
              key={service.id} 
              className="border border-pink-100 rounded-lg p-6 hover:shadow-lg transition-shadow"
            >
